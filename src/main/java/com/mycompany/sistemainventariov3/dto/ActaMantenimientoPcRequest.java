...
public class ActaMantenimientoPcRequest {

    private String subapartado;
    private String equipoSeleccionado;
    private String fechaDocumento;
    private Funcionario funcionario = new Funcionario();
    private EquipoRow desktop = new EquipoRow();
    private EquipoRow laptop = new EquipoRow();
    ...
    public String getSubapartado() {
        return subapartado;
    }

    public void setSubapartado(String subapartado) {
    ...
    public EquipoRow getDesktop() {
        return desktop;
    }

    public void setDesktop(EquipoRow desktop) {
        this.desktop = desktop;
    }

    public EquipoRow getLaptop() {
        return laptop;
    }

    public void setLaptop(EquipoRow laptop) {
        this.laptop = laptop;
    }
