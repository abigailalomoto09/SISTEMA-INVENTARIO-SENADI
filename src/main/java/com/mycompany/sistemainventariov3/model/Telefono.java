...
/**
 * Entidad Telefono sobre el modelo final equipo + telefono.
 */
@Entity
@Table(name = "equipo")
@SecondaryTable(name = "telefono", pkJoinColumns = @PrimaryKeyJoinColumn(name = "id_equipo", referencedColumnName = "id_equipo"))
@Where(clause = "tipo_equipo = 'telefono'")
public class Telefono {
    ...
    private String tipoEquipo = "telefono";
    ...
    @Column(name = "caracteristicas", table = "telefono", length = 255)
    ...
    public Telefono(String codigoSbaiOriginal, Integer item) {
