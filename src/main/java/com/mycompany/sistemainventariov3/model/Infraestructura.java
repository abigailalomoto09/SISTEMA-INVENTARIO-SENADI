...
/**
 * Entidad Infraestructura sobre el modelo final equipo + infraestructura.
 */
@Entity
@Table(name = "equipo")
@SecondaryTable(name = "infraestructura", pkJoinColumns = @PrimaryKeyJoinColumn(name = "id_equipo", referencedColumnName = "id_equipo"))
@Where(clause = "tipo_equipo = 'infraestructura'")
public class Infraestructura {
    ...
    private String tipoEquipo = "infraestructura";
    ...
    @Column(name = "subtipo", table = "infraestructura", length = 100)
    private String subtipo;

    @Column(name = "anterior_custodio", table = "infraestructura", length = 300)
    ...
    @Column(name = "caracteristicas", table = "infraestructura", length = 255)
    ...
    @Column(name = "acta_ugdt", table = "infraestructura", length = 100)
    private String actaUgdt;

    @Column(name = "acta_ugad", table = "infraestructura", length = 100)
    private String actaUgad;

    @Column(name = "anotaciones", table = "infraestructura", columnDefinition = "TEXT")
    ...
    public Infraestructura(String codigoSbaiOriginal, Integer item) {
