...
/**
 * Entidad Escaner sobre el modelo final equipo + escaner.
 */
@Entity
@Table(name = "equipo")
@SecondaryTable(name = "escaner", pkJoinColumns = @PrimaryKeyJoinColumn(name = "id_equipo", referencedColumnName = "id_equipo"))
@Where(clause = "tipo_equipo = 'escaner'")
public class Escaner {
    ...
    private String tipoEquipo = "escaner";
    ...
    @Column(name = "caracteristicas", table = "escaner", length = 255)
    ...
    public Escaner(String codigoSbaiOriginal, Integer item) {
