...
/**
 * Entidad Proyector sobre el modelo final equipo + proyector.
 */
@Entity
@Table(name = "equipo")
@SecondaryTable(name = "proyector", pkJoinColumns = @PrimaryKeyJoinColumn(name = "id_equipo", referencedColumnName = "id_equipo"))
@Where(clause = "tipo_equipo = 'proyector'")
public class Proyector {
    ...
    private String tipoEquipo = "proyector";
    ...
    @Column(name = "anterior_custodio", table = "proyector", length = 300)
    ...
    @Column(name = "caracteristicas", table = "proyector", length = 255)
    ...
    @Column(name = "acta_ugdt", table = "proyector", length = 100)
    private String actaUgdt;

    @Column(name = "acta_ugad", table = "proyector", length = 100)
    private String actaUgad;

    @Column(name = "anotaciones", table = "proyector", columnDefinition = "TEXT")
    ...
    public Proyector(String codigoSbaiOriginal, Integer item) {
