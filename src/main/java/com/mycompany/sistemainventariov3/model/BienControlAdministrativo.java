...
/**
 * Entidad BienControlAdministrativo sobre el modelo final equipo + bien_control_admin.
 */
@Entity
@Table(name = "equipo")
@SecondaryTable(name = "bien_control_admin", pkJoinColumns = @PrimaryKeyJoinColumn(name = "id_equipo", referencedColumnName = "id_equipo"))
@Where(clause = "tipo_equipo = 'bien_control_admin'")
public class BienControlAdministrativo {
    ...
    private String tipoEquipo = "bien_control_admin";
    ...
    @Column(name = "codigo_anterior", table = "bien_control_admin", length = 120)
    private String codigoAnterior;

    @Transient
    private Integer filaExcel;

    public BienControlAdministrativo() {
    }

    public BienControlAdministrativo(String codigoSbaiOriginal, Integer item) {
